<<<<<<< Updated upstream:web/html/contact.jsp
...
<head>
    ...
    <link rel="stylesheet" href="/traveltour/assets/css/style/style_contact.css">
    ...
    <div id="main">
            ...
            <div id="navbar">
                <div id="smallnav">
                    ...
                    <div class="smallnav__right">
                        <a href="https://www.facebook.com/ptientr.fb/" class="smallnav__right--icon ti-facebook"></a>
                        <a href="https://www.instagram.com/18.corner_/" class="smallnav__right--icon ti-instagram"></a>
        ...
        <div id="slider">
            <div class="slider__img">
                <img class="slider__img" src="https://lh3.googleusercontent.com/cdydO5vu87T-BzYgAT2Hbwd__DJKUYXpF3jHXXVNJ3P70a7iddshiTSAUeZnYml5HslUYj2V-SOXDskvFlSg24ShNXS-1FjP1DunJgfzpgN7N22qqsrPSHSR2j6xN9iQWDqulohIZwq114L1CmvutspyMJ_CXsgBpUD312qnn9J-Cg1tTysOnmzN6reWiqC3oAjCqlmsbmbJTDT_JzBEvX-gnkIe88O4AZs5ajhOg8tjtUgUpOho05Th_lWONNbFYPiGDa-rFjGjJOz57rZXPEZ_AnV-hbDY25KWOax1VjUQkqZ0U1QsglW1T87lgNFZjG0AC70YyRnaSLSCJMnxA4yktJqGeKhfQyuKysjV5pj7LFfivBVnlFeIp1iD2YVQiZg5oHfX4hK-opODBVwKDOMozKXBCdE_pazMVzxoQjIKs-5jkhGoa-4ENAylfyY3_wkTHv7yPCkpq1hDvH-7x8IAbhbC2nv9DdQer4XbGA3cMsI9The8jatRzmjt5MGhLpwWQfgxVdERCEdnuuCGSuF0jDv-PnDlgRBRzAQ55jEnI-K5WSW3oqKD01Qu9PgBZl4ybkBxPpF0NsOoXRsJYIOSfHieaQELUt51wIKw36JnXhMWhGCRq5DLZr6XC4NLg4G4Zms-IYUqw6nKAULUi3prthx3vtg4z4J80dyyQXWB3vbANCHNbN2Jw-sXPRPhgPqNql04Y6i4cGcpkBv5rDpxjG-YsK8FYJiqXHd6P4WefQCqbFIhD1Vh-b4SeFZC1EKU2TzkCxqIOfsqvnjeGaiDY2lQXtDUc9K99RoC707A8OdZ2Au3QJwZj-N7JxceDmkhR1o9gdvghTGQWl8hrQd-9bp2UCedoe24hhhCwCdaX7NGx6Pk0Eax_q9ekaRAt_b5oa2gUOPAV1XTk29EW9Y6AksFODY8RW9wTbhJWmZ7kLmy_8JWIty8jVDf_yOJl5ww8pGnxvMGDv9c5rZVIuvO2XfclhUBtQp3wCfC3e6-jz1CoHC3GrY=w1024-h586-no?authuser=2" alt="">
            </div>
        ...
        <div id="footer">
            ...
            <div class="footer__title__logo">
                ...
                font-weight: 600;
                color: #fff;
                line-height: 2;">The website helps tourists have an overview of Hue before coming to this ancient capital city to travel, learn about dishes and tourist destinations. Allow tours and hotels to plan before arriving in Hue.</p>
            </div>
            ...
            font-weight: 700;" class="fotter__copyright">Made by <a style="text-decoration: none; color: #3d6196" href="https://www.facebook.com/ptientr.fb/"> Tran Phuc Tien</a></p>
...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/responsive/responsive.css">
    <link rel="stylesheet" href="/traveltour/assets/css/style/style.css">
    <link rel="stylesheet" href="/traveltour/assets/css/style/style_news.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/assets/font/themify-icons/themify-icons.css">
            ...
            <div id="navbar">
                ...
                <div id="bignav">
                    ...
                    <div class="bignav__selection">
                        <ul class="bignav__selection--list">
                           <li>
                            <a href="/traveltour/index.html">Home</a>
                           </li>
                           <li>
...
<.>
>>>>>>> Stashed changes:build/web/html/news.html
