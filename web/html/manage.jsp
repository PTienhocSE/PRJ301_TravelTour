...
<%
    ...
    String displayName = (account != null) ? account.getUsername() : "";
// Lấy tên người dùng, nếu không có sẽ hiển thị "Login"
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="bignav">
                    ...
                    <div class="bignav__selection">
                        <ul class="bignav__selection--list">
                            ...
                            <li><a href="/traveltour/html/manage" style="color:white; text-decoration: none">Manage</a></li>
                        </ul>
                    </div>
